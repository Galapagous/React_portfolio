...
const ContactInput = ({title, required, placeholder, name}) => {
  return (
    <div className='bg-inherit text-white'>
        ...
        <input name={name} className='p-2 border-b-2 bg-inherit text-white w-[200px] text-lg font-thin outline-none' type="text" placeholder={placeholder}/>
    </div>
  )
}
